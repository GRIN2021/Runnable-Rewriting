/*
 * QEMU V2 compatibility header for Runnable's PTC ABI.
 *
 * This header freezes the legacy PTC ABI layout used by runnable-lift and
 * QEMU V2 live-sidecar libtinycode. Keep it self-contained in this repository
 * so the QEMU V2 build does not depend on archive/qemu-legacy-2.4.50.
 */
