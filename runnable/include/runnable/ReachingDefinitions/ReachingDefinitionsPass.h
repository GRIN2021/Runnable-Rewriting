...
#include "runnable/StackAnalysis/StackAnalysis.h"
...
public:
  ...
  virtual void releaseMemory() override {
    runnable_log(ReleaseLog, "ReachingDefinitionsPass is releasing memory");
...
public:
  ...
  virtual void releaseMemory() override {
    runnable_log(ReleaseLog, "ConditionNumberingPass is releasing memory");
...
public:
  ...
  virtual void releaseMemory() override {
    runnable_log(ReleaseLog, "ConditionalReachedLoadsPass is releasing memory");
