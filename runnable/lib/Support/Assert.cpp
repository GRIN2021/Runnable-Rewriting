...
void runnable_assert_fail(const char *AssertionBody,
                       const char *Message,
                       const char *File,
                       unsigned Line) {
...
void runnable_check_fail(const char *CheckBody,
                      const char *Message,
                      const char *File,
                      unsigned Line) {
...
void runnable_do_abort(const char *Message, const char *File, unsigned Line) {
